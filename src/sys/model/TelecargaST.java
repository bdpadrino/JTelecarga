...
public class TelecargaST {
	...
	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="incrementoIdTelecargaST")
	@SequenceGenerator(
	...
	private String  planDesc;				//Descripción del plan, crédito o débito (solamente para transacciones con pin-pad)
	...
	public Bdu getBduParameters() {
		return bduParameters;
	}
	public void setBduParameters(Bdu bduParameters) {
	...
	public String toString() {
		return "TelecargaST [id=" + id + ", rqtKey=" + rqtKey + ", bnkKey=" + bnkKey + ", bnkName=" + bnkName
				...
				+ ", tcDaysCount=" + tcDaysCount + ", serviceCarCom=" + serviceCarCom + ", comIva=" + comIva
				+ ", comMultimerchant=" + comMultimerchant + ", returnKey=" + returnKey + ", girKey=" + girKey
				+ ", sicKey=" + sicKey + ", paysheetApp=" + paysheetApp + ", amexApp=" + amexApp + ", dinersApp="
				+ dinersApp + ", servicomId=" + servicomId + ", travelAgent=" + travelAgent + ", eCommerceId="
				+ eCommerceId + ", carrierKey=" + carrierKey + ", terminalUser=" + terminalUser + ", terminalPass="
				+ terminalPass + ", terminalId=" + terminalId + ", serviceType=" + serviceType + ", phoneCarrier1="
				+ phoneCarrier1 + ", phoneCarrier2=" + phoneCarrier2 + ", phoneCarrier3=" + phoneCarrier3 + ", keybnk="
